...
from grc_utils import ACCENTS, ACUTES, count_dichrona_in_open_syllables, GRAVES, is_greek_numeral, lower_grc, normalize_word, ROUGHS
...
class Text:
    ...
    def __init__(self, text, genre='prose', debug=False, lowercase=False):
